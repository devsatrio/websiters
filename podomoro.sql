...
CREATE TABLE `karyawans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nip` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `telp` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `alamat` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `kecamatan` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `kot_kab` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  ...
  `password` text COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `api_token` text COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `status` enum('baru','lama','out') COLLATE utf8mb4_unicode_ci NOT NULL,
  `tgl_masuk` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `tgl_kotrak` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `tgl_kotrak_habis` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
