                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$item->idb}}</td>
                                <td>{{$item->produk}}</td>
                                <td>{{number_format($item->harg_pcs)}}</td>
                                <td>{{number_format($item->harg_pack)}}</td>
                                <td>{{$item->stok}}</td>
                                <td>
                                    @php
                                ...
                                <td>
                                    ...
                                    <a href="{{route('del.bproduk',['id'=>$item->id,'token'=>csrf_token()])}}"
                            ...
                            <div class="modal fade" id="mdup{{$item->idb}}">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <p class="modal-title">Update Barang</p>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                            </button>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    value="{{number_format($item->harg_pcs)}}"
                                                                    name="hrgpcs" class="form-control nm"
                                                                    placeholder="Isikan Harga Pcs Produk">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Harga Pack</label>
                                                                <input type="text"
                                                                    value="{{number_format($item->harg_pack)}}"
                                                                    name="hrgpack" class="form-control nm"
                                                                    placeholder="Isikan Harga Pack Produk">
                                                            </div>
                                                            <div class="form-group">
                            ...
                            <div class="modal fade" id="stok{{$item->idb}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('add.b.stok')}}" method="post">
                                                @csrf
                                                <div class="form-group">
                            ...
                            <div class="modal fade" id="v{{$item->idb}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <form action="{{route('update.foto.produk')}}" method="post"
                                                    enctype="multipart/form-data">
                                                    <div class="col-lg-12 col-12">
